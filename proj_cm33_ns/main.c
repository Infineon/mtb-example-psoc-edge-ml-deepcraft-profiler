...
*
* It boots the CM55 core and, when the CM33 is selected as the profiling core,
* runs the DEEPCRAFT machine learning profiler.
*
* Parameters:
*  none
*
...
#ifdef ML_DEEPCRAFT_CM33
    /* Start the profiling task if cm33 is set as the ML_DEEPCRAFT_CPU
    in the common.mk file */
    ml_profiler_run("CM33+NNLite");
#endif
