...
// Model GUID (16 bytes)
#define IMAI_MODEL_ID {0xc6, 0x44, 0xf1, 0x5d, 0x2a, 0x3d, 0xb4, 0x42, 0x8d, 0x22, 0x7e, 0x28, 0x8f, 0xfe, 0xfa, 0x87}
...
// data_in [784] (784 bytes)
#define IMAI_DATA_IN_RANK (1)
#define IMAI_DATA_IN_SHAPE (((int[]){784})
#define IMAI_DATA_IN_COUNT (784)
#define IMAI_DATA_IN_TYPE int8_t
#define IMAI_DATA_IN_TYPE_ID IMAGINET_TYPES_INT8
#define IMAI_DATA_IN_SHIFT 0
#define IMAI_DATA_IN_OFFSET 0
#define IMAI_DATA_IN_SCALE 1
#define IMAI_DATA_IN_SYMBOLS { }

// data_out [10] (10 bytes)
#define IMAI_DATA_OUT_RANK (1)
#define IMAI_DATA_OUT_SHAPE (((int[]){10})
#define IMAI_DATA_OUT_COUNT (10)
#define IMAI_DATA_OUT_TYPE int8_t
#define IMAI_DATA_OUT_TYPE_ID IMAGINET_TYPES_INT8
...
// Profiling regions
    ...
    #define IMAI_REGIONS_COUNT 1
    #define IMAI_REGIONS_NAMES {\
        "SMALL_MLP_MNIST_INT8X8",\
    }
    typedef enum {
        IMAI_SMALL_MLP_MNIST_INT8X8 = 0,
    } IMAI_Region_t;
#else
