...
// Model GUID (16 bytes)
#define IMAI_MODEL_ID {0xbb, 0x78, 0xb6, 0x57, 0x23, 0x72, 0x15, 0x45, 0x8f, 0x51, 0x42, 0xd5, 0x86, 0x35, 0xc1, 0xdf}
...
// Profiling regions
    ...
    #define IMAI_REGIONS_NAMES {\
        "SMALL_MLP_MNIST_FLOAT",\
    }
    typedef enum {
        IMAI_SMALL_MLP_MNIST_FLOAT = 0,
    } IMAI_Region_t;
#else
