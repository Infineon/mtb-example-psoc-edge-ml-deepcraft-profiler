...
The following example clones the "[ML DEEPCRAFT Profiler](https://github.com/Infineon/mtb-example-psoc-edge-ml-deepcraft-profiler)" application with the desired name "MlDeepcraftProfiler" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-ml-deepcraft-profiler --user-app-name MlDeepcraftProfiler --target-dir "C:/mtb_projects"
   ```
