...
#define ML_INPUT_SIZE_MISMATCH        1
#define ML_OUTPUT_SIZE_MISMATCH       2
#define ML_MEMORY_ALLOCATION_FAILED   3

/* Sentinel returned by calculate_mae() when the arguments are invalid */
#define CALCULATE_MAE_ERROR           (-1.0f)
